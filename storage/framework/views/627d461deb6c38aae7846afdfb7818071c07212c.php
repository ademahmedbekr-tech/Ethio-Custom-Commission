                ...
                <div class="col-12">
                  <div class="card mb-6">
                    <div class="user-profile-header-banner">
                      <img src="<?php echo e(asset('dash/assets/img/pages/profile-banner.png')); ?>" alt="Banner image" class="rounded-top" />
                    </div>

                    <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-8">
                      <div class="flex-shrink-0 mt-1 mx-sm-0 mx-auto">
    <img
      src="<?php echo e($employee->photo ? asset($employee->photo) : asset('assets/img/avatars/7.png')); ?>"
      alt="user image"
      class="d-block ms-0 h-auto ms-sm-6 rounded-3 user-profile-img"  />
</div>
                      <div class="flex-grow-1 mt-3 mt-lg-5">
                        <div
                          class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-5 flex-md-row flex-column gap-4">
                          <div class="user-profile-info">
                            <h4 class="mb-2 mt-lg-7"><?php echo e($employee->employee_name); ?></h4>
                            <ul
                              ...
                              <li class="list-inline-item">
                                ...
                                ><span class="fw-medium"> <?php echo e($employee->job_title); ?> </span>
                              </li>
                              <li class="list-inline-item">
                                <i class="icon-base bx bx-map me-2 align-top"></i
                                ><span class="fw-medium"> <?php echo e($employee->region); ?> </span>
                              </li>
                              <li class="list-inline-item">
                                <i class="icon-base bx bx-calendar me-2 align-top"></i
                                ><span class="fw-medium"> <?php echo e($employee->hire_date); ?> </span>
                              </li>
                            </ul>
                          </div>
                        ...
                        <div class="card-body invoice-preview-header rounded">
                            <div class="d-flex flex-wrap flex-column flex-sm-row justify-content-between text-heading">
                                <div class="mb-md-0 mb-6">
                                    ...
                                    <p class="mb-3">Department: <?php echo e($employee->department?->name); ?></p>
                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <object class="magnific" data="<?php echo e(asset($employee->fayda)); ?>"
                                                 ...
                                                 <a href="<?php echo e(asset($employee->fayda)); ?>"
                                                class="btn btn-primary btn-sm" download><i class="fa fa-download">Dawnload
                                                </i></a>
                                            <a class="btn btn-success btn-sm" target="_blank"
                                                href="<?php echo e(asset($employee->fayda)); ?>"><i
                                                    class="fa fa-search-plus"> </i>View Full Screen</a>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo e($employee->date_of_birth ? \Carbon\Carbon::parse($employee->date_of_birth)->format('d/m/Y') : 'N/A'); ?>

                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="pe-4 fw-medium">Gender:</td>
                                                <td><?php echo e($employee->gender == 'ወ' ? 'ወንድ' : ($employee->gender == 'ሴ' ? 'ሴት' : 'N/A')); ?>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($employee->graduation_date ? \Carbon\Carbon::parse($employee->graduation_date)->format('d/m/Y') : 'N/A'); ?>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($employee->salary ? number_format($employee->salary, 2) : 'N/A'); ?>

                                                    ETB</td>
                                            </tr>
                                            <tr>
                                                <td class="pe-4 fw-medium">Allowance:</td>
                                                <td><?php echo e($employee->allowance ? number_format($employee->allowance, 2) : 'N/A'); ?>

                                                    ETB</td>
                                            </tr>
                                            <tr>
                                                <td class="pe-4 fw-medium">Housing Allowance:</td>
                                                <td><?php echo e($employee->housing_allowance ? number_format($employee->housing_allowance, 2) : 'N/A'); ?>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($employee->assignment_date ? \Carbon\Carbon::parse($employee->assignment_date)->format('d/m/Y') : 'N/A'); ?>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <a href="<?php echo e(route('experiences.create', ['employee_id' => $employee->id])); ?>"
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $employee->experiences->sortBy('display_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($exp->from_date ? \Carbon\Carbon::parse($exp->from_date)->format('d/m/Y') : 'N/A'); ?>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    $start = $exp->from_date
                                                                        ? \Carbon\Carbon::parse($exp->from_date)
                                                                        : null;
                                                                    $end = $exp->to_date
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                                href="<?php echo e(route('experiences.show', $exp->id)); ?>">
                                                                                <i class="bx bx-show"></i> View
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                                href="<?php echo e(route('experiences.edit', $exp->id)); ?>">
                                                                        ...
                                                                        <li>
                                                                            <a class="dropdown-item text-danger"
                                                                                href="#"
                                                                                onclick="event.preventDefault(); if(confirm('Are you sure?')) document.getElementById('delete-exp-<?php echo e($exp->id); ?>').submit();">
                                                                                <i class="bx bx-trash"></i> Delete
                                                                            </a>
                                                                            <form id="delete-exp-<?php echo e($exp->id); ?>"
                                                                                action="<?php echo e(route('experiences.destroy', $exp->id)); ?>"
                                            ...
                                            <table class="table table-borderless">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($employee->created_at ? \Carbon\Carbon::parse($employee->created_at)->format('d/m/Y H:i') : 'N/A'); ?>

                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-4 fw-medium">Last Updated:</td>
                                                        <td><?php echo e($employee->updated_at ? \Carbon\Carbon::parse($employee->updated_at)->format('d/m/Y H:i') : 'N/A'); ?>
                ...
                <div class="col-lg-3 col-12 invoice-actions">
                    <div class="card mb-6">
                        <div class="card-body">
                            ...
                            <a href="<?php echo e(route('employees.pdf', $employee->id)); ?>" target="_blank"
                            ...
                            <button type="button" class="btn btn-label-danger d-grid w-100"
                                onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this employee? This action cannot be undone.')) document.getElementById('delete-employee-form').submit();">
                                <i class="bx bx-trash me-2"></i>Delete Employee
                            </button>
                            <form id="delete-employee-form" action="<?php echo e(route('employees.destroy', $employee->id)); ?>"
                                method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                            </form>
