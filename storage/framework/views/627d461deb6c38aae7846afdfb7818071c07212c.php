        ...
        <div class="col-12">
            <div class="card mb-6">
                <div class="user-profile-header-banner">
                    <img src="<?php echo e(asset('dash/assets/img/pages/profile-banner.png')); ?>" alt="Banner image"
                        class="rounded-top" />
                </div>

                <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-8">
                    <div class="flex-shrink-0 mt-1 mx-sm-0 mx-auto">
                        <img src="<?php echo e($employee->photo ? asset($employee->photo) : asset('dash/assets/img/avatars/7.png')); ?>"
                            alt="user image" class="d-block ms-0 h-auto ms-sm-6 rounded-3 user-profile-img" />
                    </div>
                            ...
                            <div class="user-profile-info">
                                ...
                                <ul
                                    ...
                                    <li class="list-inline-item">
                                        <i class="icon-base bx bx-palette me-2 align-top"></i><span class="fw-medium">
                                            <?php echo e($employee->job_title); ?> </span>
                                    </li>
                                    <li class="list-inline-item">
                                        <i class="icon-base bx bx-map me-2 align-top"></i><span class="fw-medium">
                                            <?php echo e($employee->region); ?> </span>
                                    </li>
                                    <li class="list-inline-item">
                                        <i class="icon-base bx bx-calendar me-2 align-top"></i><span class="fw-medium">
                                            <?php echo e($employee->hire_date); ?> </span>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="col-lg-3 col-12 invoice-actions">
            <div class="card mb-6">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('employees.pdf', $employee->id)); ?>"
