                                            ...
                                            <td class="text-end">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-edit')): ?>
                                                    <button class="btn btn-icon me-1"
                                                        data-bs-target="#editUser<?php echo e($user->id); ?>" data-bs-toggle="modal"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-delete')): ?>
                                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                        data-bs-target="#deleteAdmin<?php echo e($user->id); ?>" title="Delete User">
                                                        <i class="bx bx-trash"></i>
                                                    </button>


                                                    <!-- Delete Confirmation Modal -->
                                                    <div class="modal fade" id="deleteAdmin<?php echo e($user->id); ?>" tabindex="-1"
                                                        aria-hidden="true">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/users/index.blade.php ENDPATH**/ ?>