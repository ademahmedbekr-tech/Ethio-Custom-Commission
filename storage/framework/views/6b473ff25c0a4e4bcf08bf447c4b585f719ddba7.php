...
<head>
    ...
    <title>Experience Certificate - <?php echo e($employee->employee_name); ?></title>
    <style>
        @page {
            ...
            /* src: url("<?php echo e(asset('assets/img/avatars/17.png')); ?>") */
        }
...
<body>
        ...
        <div class="certificate-border">
            ...
            <div class="content">
                <div class="intro-text">
                    This is to certify that <strong class="employee-name">Mr./Ms. <?php echo e($employee->employee_name); ?></strong> was employed by our institution and has served with dedication and integrity. During their tenure, they have demonstrated exceptional professional conduct and commitment to their duties.
                </div>
                ...
                <div class="performance-text">
                    "During their employment, <?php echo e(explode(' ', $employee->employee_name)[0]); ?> has shown exemplary performance,
  ...
  <div class="date-box">
                    ...
                    <div class="date-value"><?php echo e(now()->format('F d, Y')); ?></div>
                </div>
            ...
            <div class="certificate-number">
                Certificate No: CERT-<?php echo e(date('Y')); ?>-<?php echo e(str_pad($employee->id, 4, '0', STR_PAD_LEFT)); ?>
            ...
            <div class="footer-note">
                ...
                Verified at: <?php echo e(url('/employees/' . $employee->id)); ?>
...
<?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/employees/epdf.blade.php ENDPATH**/ ?>