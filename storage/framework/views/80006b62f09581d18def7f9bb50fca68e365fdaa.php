                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="actionDropdown<?php echo e($employee->id); ?>">
                            ...
                            <li>
                               ...
                               <li>
            <a class="dropdown-item" href="<?php echo e(route('experiences.create', ['employee_id' => $employee->id])); ?>">
                <i class="bi bi-briefcase"></i> Add Work Experience
                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('employees.pdf', $employee->id)); ?> " class="btn btn-danger">
