...
<?php $__env->startSection('import', route('employees.import')); ?>
                    ...
                    <td>
                        <?php if($employee->photo): ?>
                            <div class="avatar avatar-online">
                                <img src="<?php echo e(asset($employee->photo)); ?>" alt class="rounded-circle" />
                            </div>
                            </a>
                        <?php else: ?>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="actionDropdown<?php echo e($employee->id); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('experiences.create', ['employee_id' => $employee->id])); ?>">
                                        <i class="bi bi-briefcase"></i> Add Work Experience
                                    </a>
                                </li>
                                  <li>
                                    <a class="dropdown-item"
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('fayda.verify', ['employe_id' =>$employee->id])); ?>">
                                        <i class="bi bi-printer"></i> Verify Fayda OTP
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('employees.pdf', $employee->id)); ?> "
                                        class="btn btn-danger">
                                        <i class="icon-base bx bxs-file-pdf me-2"></i> Generate PDF
                                    </a>
                                </li>
                                <li>
...
<?php echo $__env->make('layouts.components.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/employees/index.blade.php ENDPATH**/ ?>