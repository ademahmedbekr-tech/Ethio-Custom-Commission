                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    <span class="text-heading">Total managers</span>
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2"><?php echo e($totalmanagers); ?></h4>
                                        <p class="text-success mb-0">Total</p>
                                    </div>
                                    <small class="mb-0">All managers</small>
                                </div>
                                <div class="avatar">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2"><?php echo e($managersWithHeads); ?></h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2"><?php echo e($managersWithoutHeads); ?></h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2"><?php echo e($recentmanagers); ?></h4>
                                        <p class="text-info mb-0">This month</p>
                                    </div>
                                    <small class="mb-0">New managers</small>
                                </div>
                                <div class="avatar">
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    ...
                    <div class="d-flex justify-content-between align-items-center row pt-4 gap-md-0 g-6">
                        <div class="col-mb-4 align-content-end text-end">
                            <a href="<?php echo e(route('managers.create')); ?>" class="btn btn-sm btn-primary">
                ...
                <div class="card-datatable">
                    <table class="datatables-users table border-top table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($dept->id); ?></td>
                                    <td><?php echo e($dept->name); ?></td>
                                    <td>
                                        <?php echo e($dept->department?->name); ?> </td>
                                    <td><?php echo e($dept->description); ?></td>
                                    
                                    <td>
                                        <div class="d-flex gap-2">
                                            <!-- View Button -->
                                            <a href="<?php echo e(route('managers.show', $dept->id)); ?>" class="btn btn-sm btn-info"
                                                title="View Department">
                                                <i class="bx bx-show"></i>
                                            </a>

                                            <!-- Edit Button -->
                                            <a href="<?php echo e(route('managers.edit', $dept->id)); ?>"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="<?php echo e(route('managers.destroy', $dept->id)); ?>"
                ...
                <div class="mt-3">
                    <?php echo e($managers->appends(request()->query())->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/managers/index.blade.php ENDPATH**/ ?>