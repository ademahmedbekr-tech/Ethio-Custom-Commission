        ...
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header text-black">
                    <i class="bx bx-home-heart"></i> Create New Directorate
                </h5>
                <div class="card-body">
                    <form action="<?php echo e(route('directorates.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="code" class="form-label">Directorate Code</label>
                            ...
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="head_id" class="form-label">Directorate Head</label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <label for="description" class="form-label">Directorate Description</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/directorates/create.blade.php ENDPATH**/ ?>