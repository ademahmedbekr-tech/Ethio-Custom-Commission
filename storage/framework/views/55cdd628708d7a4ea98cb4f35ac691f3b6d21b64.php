                 ...
                 <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                     ...
                     <span class="position-relative">
                         ...
                         <?php if($unReadMessages > 0): ?>
                             <span
                                 class="badge rounded-pill bg-danger text-bg-danger badge-notifications ms-auto"><?php echo e($unReadMessages); ?></span>
                         <?php endif; ?>
                 ...
                 <ul class="dropdown-menu dropdown-menu-end p-0">
                             ...
                             <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                 <div class="d-flex">
                                     <div class="flex-shrink-0 me-3">
                                         <div class="avatar">
                                             <img src="<?php echo e(Auth::user()->profile_photo_path); ?>" alt
                                     ...
                                     <?php if($unReadMessages > 0): ?>
                                         <div class="flex-grow-1">
                                             ...
                                             <small class="mb-1 d-block text-body"><?php echo e($notification->description); ?>

                                             </small>
                                             <small class="text-body-secondary"> at <?php echo e($notification->created_at); ?>
                     ...
                     <li class="border-top">
                         <div class="d-grid p-4">
                             <a class="btn btn-primary btn-sm d-flex" href="<?php echo e(route('notification.index')); ?>">
             ...
             <li class="nav-item navbar-dropdown dropdown-user dropdown">
                 <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                     ...
                     <div class="avatar avatar-online">
                         <img src="<?php echo e(asset('dash/assets/img/avatars/1.png')); ?>" alt class="rounded-circle" />
                     </div>
                 </a>
                 <ul class="dropdown-menu dropdown-menu-end">
                     <li>
                         <a class="dropdown-item" href="pages-account-settings-account.html">
                             <div class="d-flex">
                                 <div class="flex-shrink-0 me-3">
                                     <div class="avatar avatar-online">
                                         <img src="<?php echo e(asset('dash/assets/img/avatars/1.png')); ?>" alt
                                             class="w-px-40 h-auto rounded-circle" />
                                     </div>
                                 </div>
                                 <div class="flex-grow-1">
                                     <h6 class="mb-0"><?php echo e(Auth::user()->name); ?></h6>
                                     <small class="text-body-secondary"><?php echo e(Auth::user()->roles[0]->name); ?></small>
                                 </div>
                             </div>
                         </a>
                     </li>
...
<?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/layouts/nav.blade.php ENDPATH**/ ?>