                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                        ...
                                        <form action="<?php echo $__env->yieldContent('import'); ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <button class="btn btn-sm btn-success">
                                                    Import <?php echo $__env->yieldContent('insert'); ?>
                                                </button>
                                            </div>
                                    ...
                                    <div class="col-md-4 text-end">
                                        ...
                                        <a href="<?php echo e(route('employees.export-csv')); ?>?<?php echo e(http_build_query(request()->query())); ?>"
                                            class="btn btn-sm btn-info">
                                            <i class="bx bx-download"></i> Export
                                        </a>

                                        
                                        <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-sm btn-success">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="nav-align-top">
                                                <ul class="nav nav-pills flex-nowrap overflow-auto gap-1">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link <?php echo e(!request('region_filter') ? 'active' : ''); ?>"
                                                            href="<?php echo e(request()->fullUrlWithQuery(['region_filter' => null, 'page' => 1])); ?>">
                                                            All Regions
                                                            <span class="badge bg-success rounded-pill ms-1">
                                                                <?php echo e($totalCount ?? 0); ?>
                                                    ...
                                                    <?php $__currentLoopData = $regionCount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="nav-item">
                                                            <a class="nav-link <?php echo e(request('region_filter') == $region ? 'active' : ''); ?>"
                                                                href="<?php echo e(request()->fullUrlWithQuery(['region_filter' => $region, 'page' => 1])); ?>">
                                                                <?php echo e($region); ?>

                                                                <span class="badge bg-success rounded-pill ms-1">
                                                                    <?php echo e($rcount[$region] ?? 0); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <?php if(request('status') == 'inactive'): ?>
                                            <form id="bulk-restore-form" method="POST"
                                                action="<?php echo e(route('employees.bulk-restore')); ?>" class="d-inline ms-2">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ODA-Membership\ODA-Membership\resources\views/layouts/components/index.blade.php ENDPATH**/ ?>