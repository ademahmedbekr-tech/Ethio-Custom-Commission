...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="code"
                           class="form-control font-monospace <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <option value="Head Office" <?php echo e(old('branch_type') == 'Head Office' ? 'selected' : ''); ?>>
                            Head Office (Exclusive Directorate Structure)
                        </option>
                        <option value="Dry Port" <?php echo e(old('branch_type') == 'Dry Port' ? 'selected' : ''); ?>>
                            Dry Port (Regional Work Process Structure)
                        </option>
                        <option value="Airport Customs" <?php echo e(old('branch_type') == 'Airport Customs' ? 'selected' : ''); ?>>
                            Airport Customs
                        </option>
                        <option value="Border Office" <?php echo e(old('branch_type') == 'Border Office' ? 'selected' : ''); ?>>
                            Border Office
                        </option>
                        <option value="Regional Office" <?php echo e(old('branch_type') == 'Regional Office' ? 'selected' : ''); ?>>
                            Regional Office
                        </option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <textarea name="address"
                              rows="3"
                              class="form-control"
                              placeholder="Describe physical building parameters or landmarks..."><?php echo e(old('address')); ?></textarea>
                </div>
            </div>
