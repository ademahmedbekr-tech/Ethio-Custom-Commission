    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('experiences.update', $experience->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                   id="job_title"
                                                   name="job_title"
                                                   value="<?php echo e(old('job_title', $experience->job_title)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                   id="institution"
                                                   name="institution"
                                                   value="<?php echo e(old('institution',$experience->institution)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="previous" <?php echo e(old('experience_type', $experience->experience_type) == 'previous' ? 'selected' : ''); ?>>Previous Experience</option>
                                                <option value="current" <?php echo e(old('experience_type',$experience->experience_type) == 'current' ? 'selected' : ''); ?>>Current Experience</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control <?php $__errorArgs = ['in_outside'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    id="in_outside"
                                                    name="in_outside">
                                                <option value="outside" <?php echo e(old('in_outside') == 'outside' ? 'selected' : ''); ?>>Outside Experience</option>
                                                <option value="inside" <?php echo e(old('in_outside') == 'inside' ? 'selected' : ''); ?>>Inside Experience</option>
                                            </select>
                                            <?php $__errorArgs = ['in_outside'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                   id="from_date"
                                                   name="from_date"
                                                   value="<?php echo e(old('from_date', $experience->from_date)); ?>"
                                                   required>
...
unset($__errorArgs, $__bag); ?>"
                                                   id="to_date"
                                                   name="to_date"
                                                   value="<?php echo e(old('to_date',$experience->to_date)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/experiences/edit.blade.php ENDPATH**/ ?>