...
unset($__errorArgs, $__bag); ?>" id="file_number"
                                            name="file_number" value="<?php echo e(old('file_number')); ?>"
...
unset($__errorArgs, $__bag); ?>" id="gender"
                                            ...
                                            <option value="ወ" <?php echo e(old('gender') == 'ወ' ? 'selected' : ''); ?>>ወንድ / Male
                                            </option>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="Single"
                                                <?php echo e(old('marital_status') == 'Single' ? 'selected' : ''); ?>>ነጠላ / Single
                                            </option>
                                            <option value="Married"
                                                <?php echo e(old('marital_status') == 'Married' ? 'selected' : ''); ?>>ያገቡ / Married
                                            </option>
                                            <option value="Divorced"
                                                <?php echo e(old('marital_status') == 'Divorced' ? 'selected' : ''); ?>>የተፋቱ / Divorced
                                            </option>
                                            <option value="Widowed"
                                                <?php echo e(old('marital_status') == 'Widowed' ? 'selected' : ''); ?>>ባል/ሚስት የሞቱ /
                                                Widowed</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" id="ethnicity"
                                            ...
                                            <option value="Oromo" <?php echo e(old('ethnicity') == 'Oromo' ? 'selected' : ''); ?>>ኦሮሞ
                                                / Oromo</option>
                                            <option value="Amhara" <?php echo e(old('ethnicity') == 'Amhara' ? 'selected' : ''); ?>>አማራ
                                                / Amhara</option>
                                            <option value="Tigray" <?php echo e(old('ethnicity') == 'Tigray' ? 'selected' : ''); ?>>
                                                ትግራይ / Tigray</option>
                                            ...
                                            <option value="Gurage" <?php echo e(old('ethnicity') == 'Gurage' ? 'selected' : ''); ?>>ጉራጌ
                                                / Gurage</option>
                                            <option value="Other" <?php echo e(old('ethnicity') == 'Other' ? 'selected' : ''); ?>>ሌላ /
                                                Other</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" id="religion"
                                            ...
                                            <option value="ኦርቶዶክስ" <?php echo e(old('religion') == 'ኦርቶዶክስ' ? 'selected' : ''); ?>>
                                                Orthodox</option>
                                            ...
                                            <option value="Waaqeeffannaa"
                                                <?php echo e(old('religion') == 'Waaqeeffannaa' ? 'selected' : ''); ?>>Waaqeeffannaa
                                            </option>
...
unset($__errorArgs, $__bag); ?>" id="region"
                                            ...
                                            <option value="Addis Ababa"
                                                <?php echo e(old('region') == 'Addis Ababa' ? 'selected' : ''); ?>>አዲስ አበባ / Addis
                                                Ababa</option>
                                            <option value="Afar" <?php echo e(old('region') == 'Afar' ? 'selected' : ''); ?>>አፋር /
                                                Afar</option>
                                            <option value="Amhara" <?php echo e(old('region') == 'Amhara' ? 'selected' : ''); ?>>አማራ /
                                                Amhara</option>
                                            ...
                                            <option value="Dire Dawa"
                                                <?php echo e(old('region') == 'Dire Dawa' ? 'selected' : ''); ?>>ድሬዳዋ / Dire Dawa
                                            </option>
                                            <option value="Gambela" <?php echo e(old('region') == 'Gambela' ? 'selected' : ''); ?>>
                                                ጋምቤላ / Gambela</option>
                                            <option value="Harari" <?php echo e(old('region') == 'Harari' ? 'selected' : ''); ?>>ሐረሪ /
                                                Harari</option>
                                            <option value="Oromia" <?php echo e(old('region') == 'Oromia' ? 'selected' : ''); ?>>ኦሮሚያ
                                                / Oromia</option>
                                            <option value="Sidama" <?php echo e(old('region') == 'Sidama' ? 'selected' : ''); ?>>ሲዳማ /
                                                Sidama</option>
                                            <option value="Somali" <?php echo e(old('region') == 'Somali' ? 'selected' : ''); ?>>ሶማሌ /
                                                Somali</option>
                                            <option value="SNNPR" <?php echo e(old('region') == 'SNNPR' ? 'selected' : ''); ?>>ደቡብ /
                                                SNNPR</option>
                                            <option value="Tigray" <?php echo e(old('region') == 'Tigray' ? 'selected' : ''); ?>>ትግራይ
                                                / Tigray</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="job_level" name="job_level"
                                            value="<?php echo e(old('job_level')); ?>" min="1" max="100"
                                            placeholder="1-20">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="step" name="step"
                                            value="<?php echo e(old('step')); ?>" min="1" max="20"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="assignment_date"
                                            name="assignment_date" value="<?php echo e(old('assignment_date')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="salary"
                                            name="salary" value="<?php echo e(old('salary')); ?>" placeholder="0.00">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="housing_allowance"
                                            name="housing_allowance" value="<?php echo e(old('housing_allowance')); ?>"
                                            placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="education_level" name="education_level">
                                            ...
                                            <option value="High School"
                                                <?php echo e(old('education_level') == 'High School' ? 'selected' : ''); ?>>ሁለተኛ ደረጃ /
                                                High School</option>
                                            <option value="Certificate"
                                                <?php echo e(old('education_level') == 'Certificate' ? 'selected' : ''); ?>>ሰርተፍኬት /
                                                Certificate</option>
                                            <option value="Diploma"
                                                <?php echo e(old('education_level') == 'Diploma' ? 'selected' : ''); ?>>ዲፕሎማ / Diploma
                                            </option>
                                            <option value="Bachelor"
                                                <?php echo e(old('education_level') == 'Bachelor' ? 'selected' : ''); ?>>ባችለር /
                                                Bachelor</option>
                                            <option value="Master"
                                                <?php echo e(old('education_level') == 'Master' ? 'selected' : ''); ?>>ማስተርስ / Master
                                            </option>
                                            <option value="PhD"
                                                <?php echo e(old('education_level') == 'PhD' ? 'selected' : ''); ?>>ዶክትሬት / PhD
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="education_type"
                                            name="education_type" value="<?php echo e(old('education_type')); ?>"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="graduation_date"
                                            name="graduation_date" value="<?php echo e(old('graduation_date')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="cgpa"
                                            name="cgpa" value="<?php echo e(old('cgpa')); ?>" placeholder="0.00"
                                            max="4.00">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="previous_job_title"
                                                    name="previous_job_title" value="<?php echo e(old('previous_job_title')); ?>">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="previous_from"
                                                        name="previous_from" value="<?php echo e(old('previous_from')); ?>">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="previous_to" class="form-label">እስከ / To</label>
                                                    <input type="date" class="form-control" id="previous_to"
                                                        name="previous_to" value="<?php echo e(old('previous_to')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="disability_type" name="disability_type">
                                            ...
                                            <option value="None"
                                                <?php echo e(old('disability_type') == 'None' ? 'selected' : ''); ?>>የለም / None
                                            </option>
                                            <option value="Physical"
                                                <?php echo e(old('disability_type') == 'Physical' ? 'selected' : ''); ?>>አካላዊ /
                                                Physical</option>
                                            <option value="Visual"
                                                <?php echo e(old('disability_type') == 'Visual' ? 'selected' : ''); ?>>የማየት / Visual
                                            </option>
                                            <option value="Hearing"
                                                <?php echo e(old('disability_type') == 'Hearing' ? 'selected' : ''); ?>>የመስማት / Hearing
                                            </option>
                                        </select>
                                    </div>
                                </div>
