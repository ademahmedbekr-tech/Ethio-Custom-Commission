    ...
    <div class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="addPermissionForm"  action= "<?php echo e(route('permission.store')); ?>" method="POST" class="row"
                    ...
                    <div class="col-12 form-control-validation mb-4">
                        <label class="form-label" for="GuardName">Guard Name</label>
...
<!--/ Add Permission Modal -->
<?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ecc-profiles\resources\views/_partials/_modals/modal-add-permission.blade.php ENDPATH**/ ?>