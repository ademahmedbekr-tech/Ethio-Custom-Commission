...
<head>
    ...
    <title>Login to | ECC</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    
    <link rel="icon" style="border-radius: 50%" type="image" href="<?php echo e(asset('Photo/Picture1.jpg')); ?>" />
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        <!-- Logo -->
                            ...
                            <h5 class="card-title"><strong><?php echo e(__('Ethiopian Customs Commission(ECC) ')); ?></strong></h5>
                            <img src="<?php echo e(asset('Photo/Picture1.jpg')); ?>" alt="Logo" class="w-20 h-20"
                        ...
                        <form class="form mb-6" action ="<?php echo e(route('login')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ECC\ODA-Membership\ODA-Membership\resources\views/auth/login.blade.php ENDPATH**/ ?>