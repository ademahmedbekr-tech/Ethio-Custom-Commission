...
use App\Models\Frontend\BannerImage;
use App\Models\Frontend\HomeSection;
use App\Models\Frontend\ManagePage;
...
use App\Models\Frontend\ConditionPrivacy;
use App\Models\Frontend\ContactInformation;
use App\Models\Frontend\CustomePage;
use App\Models\Frontend\CustomPaginator;
use App\Models\Frontend\Department;
use App\Models\Frontend\EmailTemplate;
use App\Models\Frontend\FaqCategory;
use Mail;
use App\Models\Frontend\Feature;
use App\Models\Frontend\Lawyer;
use App\Models\Frontend\Location;
use App\Models\Frontend\ManageText;
use App\Models\Frontend\Navigation;
use App\Models\Frontend\NotificationText;
use App\Models\Frontend\Overview;
use App\Models\Frontend\Service;
use App\Models\Frontend\Setting;
use App\Models\Frontend\Slider;
use App\Models\Frontend\Subscribe;
use App\Models\Frontend\Testimonial;
use App\Models\Frontend\ValidationText;
use App\Models\Frontend\Work;
use App\Models\Frontend\WorkFaq;
...
class FrontendController extends Controller
{
    ...
    public function index(){
        ...
        $features=Feature::where('status',1)->where('language', getLangauge())->get();
        $blogs=Blog::where('language',getLangauge())->orderBy('id','desc')->get();
        $feature_blog=Blog::where('show_feature_blog',1)->where('language', getLangauge())->orderBy('id','desc')->first();
        ...
        return view('front.home',compact('services','blogs','feature_blog','departments','services','lawyers','locations','features','testimonials','lawyersForSearch','departmentsForSearch','homesections','sliders','work','workFaqs','title_meta','overviews','banner','website_lang','blog_count','isRtl'));
    }
    ...
    public function aboutUs(){
        ...
        return view('front.about',compact('about','title_meta','work','workFaqs','overviews','banner','navigation','about_count'));
    }
    ...
    public function Faq(){
        ...
        $banner=$this->banner;
        $navigation=Navigation::first();
        return view('front.faq',compact('faqCategories','title_meta','banner','navigation'));
    }

    public function blog(){
        Paginator::useBootstrap();
        $pagination_qty=CustomPaginator::where('id',2)->first()->qty;
        $blogs=Blog::orderBy('id','desc')->where('status',1)->where('language', getLangauge())->paginate($pagination_qty);
        $title_meta=$this->title_meta;
        $banner=$this->banner;
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        $setting=Setting::first();
        $isRtl=$setting->text_direction;
        return view('front.blog.index',compact('blogs','title_meta','banner','navigation','website_lang','isRtl'));
    }
    ...
    public function blogDetails($slug){
        ...
        $website_lang=ManageText::all();
        $isRtl=$setting->text_direction;
        return view('front.blog.show',compact('blog','blogCategories','title_meta','latestBlog','setting','banner','navigation','website_lang','isRtl'));
    }
    ...
    public function blogCategory($slug){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.blog.category-blog',compact('category','blogs','title_meta','banner','navigation','website_lang'));
    }
    ...
    public function contactUs(){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.contact-us',compact('contactUs','title_meta','setting','banner','navigation','website_lang'));
    }
    ...
    public function lawyer(){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.lawyer.index',compact('lawyers','departments','locations','lawyersForSearch','title_meta','banner','navigation','website_lang'));
    }
    ...
    public function lawyerDetails($slug){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.lawyer.show',compact('lawyer','title_meta','currency','banner','navigation','website_lang'));
    }
    ...
    public function searchLawyer(Request $request){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.lawyer.index',compact('lawyers','departments','locations','lawyersForSearch','location_id','lawyer_id','department_id','title_meta','banner','navigation','website_lang'));
    }
    ...
    public function department(){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.department.index',compact('departments','title_meta','banner','navigation','website_lang'));
    }
    ...
    public function departmentDetails($slug){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.department.show',compact('department','departments','lawyers','contactInfo','title_meta','setting','description','banner','navigation','website_lang'));
    }
    ...
    public function service(){
        ...
        $setting=Setting::first();
        $isRtl=$setting->text_direction;
        return view('front.service.index',compact('services','title_meta','banner','navigation','website_lang','isRtl'));
    }
    ...
    public function serviceDetails($slug){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('front.service.show',compact('service','services','contactInfo','title_meta','setting','banner','navigation','website_lang'));
    }
    ...
    public function testimonial(){
        ...
        $banner=$this->banner;
        $navigation=Navigation::first();
        return view('front.testimonial',compact('testimonials','title_meta','banner','navigation'));
    }
    ...
    public function termsCondition(){
        ...
        return view('front.terms-condition',compact('condition','banner','navigation','condition_count'));
    }
    ...
    public function privacyPolicy(){
        ...
        return view('front.privacy-policy',compact('condition','banner','navigation','privacy_count'));
    }
    ...
    public function customePage($slug){
        ...
        $banner=$this->banner;
        $navigation=Navigation::first();
        return view('front.custom-page',compact('page','title_meta','banner','navigation'));
    }
}
