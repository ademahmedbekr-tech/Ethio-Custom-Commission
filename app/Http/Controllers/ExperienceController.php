...
class ExperienceController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            if (! $employeeId) {
                // Build query for all experiences
                $query = EmployeeExperience::with('employee');
            ...
            // Build query for employee experiences
            $query = $employee->experiences();
            ...
            $experiences = $query->orderBy('experience_type', 'desc')
