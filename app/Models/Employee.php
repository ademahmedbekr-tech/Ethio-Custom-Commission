...
class Employee extends Model
{
     ...
     */
    public function currentExperience(): HasMany
    {
        return $this->hasMany(EmployeeExperience::class, 'employee_id')
                    ->where(function($query) {
                        $query->where('to_date', null)
                              ->orWhere('is_current', true)
                              ->orWhere('experience_type', 'current');
                    })
                    ->orderBy('from_date', 'desc')
                    ->limit(1);
    }
    ...
    /**
     * Get previous experiences (completed experiences)
     */
    public function previousExperiences(): HasMany
    {
        return $this->hasMany(EmployeeExperience::class, 'employee_id')
                    ->whereNotNull('to_date')
                    ->where('is_current', false)
                    ->where('experience_type', 'previous')
                    ->orderBy('from_date', 'desc');
    }
     ...
     */
    public function experiencesByType($type): HasMany
    {
        return $this->hasMany(EmployeeExperience::class, 'employee_id')
    ...
    /**
     * Scope a query to only include male employees.
     */
    ...
    /**
     * Scope a query to only include female employees.
     */
    ...
    /**
     * Scope a query to only include employees by job title.
     */
    ...
    /**
     * Scope a query to only include employees by region.
     */
    ...
    /**
     * Scope a query to only include employees by education level.
     */
    ...
    /**
     * Scope a query to only include employees by marital status.
     */
    ...
    /**
     * Scope a query to only include employees hired between dates.
     */
    ...
    /**
     * Scope a query to only include employees born between dates.
     */
    ...
    /**
     * Scope a query to only include employees with COC certificate.
     */
    ...
    /**
     * Scope a query to only include employees with disability.
     */
    ...
    /**
     * Scope a query to only include employees with salary above amount.
     */
    ...
    /**
     * Scope a query to only include employees with salary below amount.
     */
