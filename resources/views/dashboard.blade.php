                    ...
                    <div class="d-flex align-items-start row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary mb-3">Hi,{{ Auth::user()->name }}</h5>
                          <p class="mb-6">
                            Oromia Development Association<br />
                          </p>
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    {{-- <img src="{{ asset('dash/assets/img/front-pages/icons/user-success.svg') }}" alt="Credit Card" class="rounded" /> --}}
                ...
                <div class="col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="card-title text-nowrap mb-2"> {{ $branch }} </h3>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('dash/assets/img/icons/brands/chrome.png') }}"
                                      alt="Chrome"
                                      height="24"
                                      class="me-3" />
                                ...
                                <td class="text-heading"> {{ $ethinicity }} </td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('dash/assets/img/icons/brands/safari.png') }}"
                                      alt="Safari"
                                      height="24"
                                      class="me-3" />
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('dash/assets/img/icons/brands/firefox.png') }}"
                                      alt="Firefox"
                                      height="24"
                                      class="me-3" />
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('dash/assets/img/icons/brands/edge.png') }}"
                                      alt="Edge"
                                      height="24"
                                      class="me-3" />
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('dash/assets/img/icons/brands/opera.png') }}"
                                      alt="Opera"
                                      height="24"
                                      class="me-3" />
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img src="{{ asset('dash/assets/img/icons/brands/uc.png') }}" alt="uc" height="24" class="me-3" />
