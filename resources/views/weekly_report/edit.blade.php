...
@section('content')
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('weekly.update', $report->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                 @method('PUT')
                   ...
                   {{-- <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="week" id="week" class="form-control">
                            <option value="{{ $report->week }} ">Select </option>
                        </select>
                    </div>
                </div> --}}
                  <div class="row mb-3">
                        <div class="col-md-6">
                            <input type="text" name="zone" placeholder="Godina"
                                value="{{$report->zone}}"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <input type="number" name="H_Mootummaa" placeholder="Hojjataa Mootummaa" value="{{$report->H_Mootummaa }}"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <input type="number" name="geejjiba" placeholder="Geejibaa fi Galii adda addaa"
                                value="{{ $report->geejjiba }}" class="form-control @error('geejjiba') is-invalid @enderror">
                            @error('geejjiba')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            <input type="number" name="sector" placeholder="Sektaroota" value="{{ $report->sector }}"
                      ...
                      <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="category">
                                ...
                                <option value="zone" {{$report->category ==  'zone' ? 'selected' : ''}}>Zone</option>
                                <option value="city" {{ $report->category == 'city' ? 'selected' : ''  }} >City</option>

                            </select>
                        </div>
                          <div class="col-md-6">
                            <input type="number" name="total_plan" placeholder="Plan" value="{{ $report->total_plan }}"
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    $('#week').append('<option value="'+value+'">'+value+'</option>');
                });
            }
        });
    } else {
