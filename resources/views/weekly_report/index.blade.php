                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-6">
                                    <!-- Filter Form -->
                                    <form action="{{ route('weekly.index') }}" method="GET"
                                ...
                                <div class="col-3 mb-3 align-content-center" style="text-align: right;">
                                    <a href="{{ route('weekly.create') }}" class="btn btn-sm btn-success">Add Report</a>
                                </div>
                            </div>
                                ...
                                <table class="table table-strip table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Category</th>
                                            <th>Qonnaan Bulaa</th>
                                            <th>Hojjataa Mootummaa</th>
                                            <th>Jiraataa magaalaa</th>
                                            <th>Daldalaa A-C</th>
                                            <th>Geejjiba</th>
                                            <th>Sektaroota</th>
                                            <th>Karoora</th>
                                    ...
                                    <tbody>
                                        @forelse($reports as $report)
                                            <tr>
                                                ...
                                                <td>{{ $report->qonnaa_bulaa }}</td>
                                                <td>{{ $report->H_Mootummaa }}</td>
                                                <td>{{ $report->J_magaalaa }}</td>
                                                <td>{{ $report->daldalaa_a_c }}</td>
                                                <td>{{ $report->geejjiba }}</td>
                                                <td>{{ $report->sector }}</td>
                                                <td>{{ $report->total_plan }}</td>
                                                <td>{{ $report->total_achieve }}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu"
                                                            ...
                                                            @can('gujii-edit')
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('weekly.edit', $report->id) }}">
                                                                        Edit
                                                                    </a>
                                                                </li>
                                                            @endcan
                                                            ...
                                                            @can('gujii-delete')
                                                                <li>
                                                                    <form action="{{ route('weekly.destroy', $report->id) }}"
                                                                        method="POST"
