                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('file_number') is-invalid @enderror" id="file_number"
                                            name="file_number" value="{{ old('file_number', $employee->file_number) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('gender') is-invalid @enderror" id="gender"
                                            ...
                                            <option value="ወ"
                                                {{ old('gender', $employee->gender) == 'ወ' ? 'selected' : '' }}>ወንድ / Male
                                            </option>
                                            <option value="ሴ"
                                                {{ old('gender', $employee->gender) == 'ሴ' ? 'selected' : '' }}>ሴት / Female
                                            </option>
                                            <option value="ሌላ"
                                                {{ old('gender', $employee->gender) == 'ሌላ' ? 'selected' : '' }}>ሌላ / Other
                                            </option>
                                        </select>
                                        @error('gender')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('ethnicity') is-invalid @enderror" id="ethnicity"
                                            ...
                                            <option value="Oromo"
                                                {{ old('ethnicity', $employee->ethnicity) == 'Oromo' ? 'selected' : '' }}>
                                                ኦሮሞ / Oromo</option>
                                            <option value="Amhara"
                                                {{ old('ethnicity', $employee->ethnicity) == 'Amhara' ? 'selected' : '' }}>
                                                አማራ / Amhara</option>
                                            <option value="Tigray"
                                                {{ old('ethnicity', $employee->ethnicity) == 'Tigray' ? 'selected' : '' }}>
                                                ትግራይ / Tigray</option>
                                            <option value="Somali"
                                                {{ old('ethnicity', $employee->ethnicity) == 'Somali' ? 'selected' : '' }}>
                                                ሶማሌ / Somali</option>
                                            <option value="Gurage"
                                                {{ old('ethnicity', $employee->ethnicity) == 'Gurage' ? 'selected' : '' }}>
                                                ጉራጌ / Gurage</option>
                                            <option value="Other"
                                                {{ old('ethnicity', $employee->ethnicity) == 'Other' ? 'selected' : '' }}>
                                                ሌላ / Other</option>
                                        </select>
                                        @error('ethnicity')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('region') is-invalid @enderror" id="region"
                                            ...
                                            <option value="Addis Ababa"
                                                {{ old('region', $employee->region) == 'Addis Ababa' ? 'selected' : '' }}>
                                                አዲስ አበባ / Addis Ababa</option>
                                            <option value="Afar"
                                                {{ old('region', $employee->region) == 'Afar' ? 'selected' : '' }}>አፋር /
                                                Afar</option>
                                            <option value="Amhara"
                                                {{ old('region', $employee->region) == 'Amhara' ? 'selected' : '' }}>አማራ /
                                                Amhara</option>
                                            <option value="Benishangul-Gumuz"
                                                {{ old('region', $employee->region) == 'Benishangul-Gumuz' ? 'selected' : '' }}>
                                                ቤንሻንጉል ጉሙዝ / Benishangul-Gumuz</option>
                                            <option value="Dire Dawa"
                                                {{ old('region', $employee->region) == 'Dire Dawa' ? 'selected' : '' }}>
                                                ድሬዳዋ / Dire Dawa</option>
                                            <option value="Gambela"
                                                {{ old('region', $employee->region) == 'Gambela' ? 'selected' : '' }}>ጋምቤላ
                                                / Gambela</option>
                                            <option value="Harari"
                                                {{ old('region', $employee->region) == 'Harari' ? 'selected' : '' }}>ሐረሪ /
                                                Harari</option>
                                            <option value="Oromia"
                                                {{ old('region', $employee->region) == 'Oromia' ? 'selected' : '' }}>ኦሮሚያ /
                                                Oromia</option>
                                            <option value="Sidama"
                                                {{ old('region', $employee->region) == 'Sidama' ? 'selected' : '' }}>ሲዳማ /
                                                Sidama</option>
                                            <option value="Somali"
                                                {{ old('region', $employee->region) == 'Somali' ? 'selected' : '' }}>ሶማሌ /
                                                Somali</option>
                                            <option value="SNNPR"
                                                {{ old('region', $employee->region) == 'SNNPR' ? 'selected' : '' }}>ደቡብ /
                                                SNNPR</option>
                                            <option value="Tigray"
                                                {{ old('region', $employee->region) == 'Tigray' ? 'selected' : '' }}>ትግራይ /
                                                Tigray</option>
                                        </select>
                                        @error('region')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="zone" name="zone"
                                            value="{{ old('zone', $employee->zone) }}" placeholder="ዞን / Zone">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="specific_location"
                                            ...
                                            value="{{ old('specific_location', $employee->specific_location) }}"
                                            placeholder="ከተማ / ቀበሌ">
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('fan_number') is-invalid @enderror"
                                            id="fan_number" name="fan_number"
                                            value="{{ old('fan_number', $employee->fan_number) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="step" name="step"
                                            value="{{ old('step', $employee->step) }}" min="1" max="20"
                                            placeholder="1-20">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="assignment_date"
                                            ...
                                            value="{{ old('assignment_date', $employee->assignment_date ? $employee->assignment_date->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pension_id" name="pension_id"
                                            value="{{ old('pension_id', $employee->pension_id) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="allowance"
                                            name="allowance" value="{{ old('allowance', $employee->allowance) }}"
                                            placeholder="0.00">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="education_level" name="education_level">
                                            ...
                                            <option value="High School"
                                                {{ old('education_level', $employee->education_level) == 'High School' ? 'selected' : '' }}>
                                                ሁለተኛ ደረጃ / High School</option>
                                            <option value="Certificate"
                                                {{ old('education_level', $employee->education_level) == 'Certificate' ? 'selected' : '' }}>
                                                ሰርተፍኬት / Certificate</option>
                                            <option value="Diploma"
                                                {{ old('education_level', $employee->education_level) == 'Diploma' ? 'selected' : '' }}>
                                                ዲፕሎማ / Diploma</option>
                                            <option value="Bachelor"
                                                {{ old('education_level', $employee->education_level) == 'Bachelor' ? 'selected' : '' }}>
                                                ባችለር / Bachelor</option>
                                            <option value="Master"
                                                {{ old('education_level', $employee->education_level) == 'Master' ? 'selected' : '' }}>
                                                ማስተርስ / Master</option>
                                            <option value="PhD"
                                                {{ old('education_level', $employee->education_level) == 'PhD' ? 'selected' : '' }}>
                                                ዶክትሬት / PhD</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="education_type"
                                            name="education_type"
                                            value="{{ old('education_type', $employee->education_type) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="graduation_date"
                                            ...
                                            value="{{ old('graduation_date', $employee->graduation_date ? $employee->graduation_date->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="cgpa"
                                            name="cgpa" value="{{ old('cgpa', $employee->cgpa) }}" placeholder="0.00"
                                            max="4.00">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="coc_certificate"
                                                ...
                                                {{ old('coc_certificate', $employee->coc_certificate) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="higher_ed_verified"
                                                ...
                                                {{ old('higher_ed_verified', $employee->higher_ed_verified) ? 'checked' : '' }}>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="current_institution"
                                                    ...
                                                    value="{{ old('current_institution', $employee->current_institution) }}">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="experience_from"
                                                        ...
                                                        value="{{ old('experience_from', $employee->experience_from ? $employee->experience_from->format('Y-m-d') : '') }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="experience_to" class="form-label">እስከ / To</label>
                                                    <input type="date" class="form-control" id="experience_to"
                                                        name="experience_to"
                                                        value="{{ old('experience_to', $employee->experience_to ? $employee->experience_to->format('Y-m-d') : '') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="previous_job_title"
                                                    ...
                                                    value="{{ old('previous_job_title', $employee->previous_job_title) }}">
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="previous_institution"
                                                    ...
                                                    value="{{ old('previous_institution', $employee->previous_institution) }}">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="previous_from"
                                                        name="previous_from"
                                                        value="{{ old('previous_from', $employee->previous_from ? $employee->previous_from->format('Y-m-d') : '') }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="previous_to" class="form-label">እስከ / To</label>
                                                    <input type="date" class="form-control" id="previous_to"
                                                        name="previous_to"
                                                        value="{{ old('previous_to', $employee->previous_to ? $employee->previous_to->format('Y-m-d') : '') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="disability_type" name="disability_type">
                                            ...
                                            <option value="None"
                                                {{ old('disability_type', $employee->disability_type) == 'None' ? 'selected' : '' }}>
                                                የለም / None</option>
                                            <option value="Physical"
                                                {{ old('disability_type', $employee->disability_type) == 'Physical' ? 'selected' : '' }}>
                                                አካላዊ / Physical</option>
                                            <option value="Visual"
                                                {{ old('disability_type', $employee->disability_type) == 'Visual' ? 'selected' : '' }}>
                                                የማየት / Visual</option>
                                            <option value="Hearing"
                                                {{ old('disability_type', $employee->disability_type) == 'Hearing' ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="card-body text-center">
                                                    <img src="{{ asset($employee->photo) }}" alt="Photo"
