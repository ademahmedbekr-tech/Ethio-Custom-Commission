                ...
                <div class="col-12">
                  <div class="card mb-6">
                    <div class="user-profile-header-banner">
                      <img src="{{ asset('dash/assets/img/pages/profile-banner.png') }}" alt="Banner image" class="rounded-top" />
                    </div>

                    <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-8">
                      <div class="flex-shrink-0 mt-1 mx-sm-0 mx-auto">
    <img
      src="{{ $employee->photo ? asset($employee->photo) : asset('assets/img/avatars/7.png') }}"
      alt="user image"
                          ...
                          <div class="user-profile-info">
                            ...
                            <ul
                              ...
                              <li class="list-inline-item">
                                ...
                                ><span class="fw-medium"> {{ $employee->job_title }} </span>
                              </li>
                              <li class="list-inline-item">
                                <i class="icon-base bx bx-map me-2 align-top"></i
                                ><span class="fw-medium"> {{ $employee->region }} </span>
                              </li>
                              <li class="list-inline-item">
                                <i class="icon-base bx bx-calendar me-2 align-top"></i
                                ><span class="fw-medium"> {{ $employee->hire_date }} </span>
                              </li>
                            </ul>
                          </div>
