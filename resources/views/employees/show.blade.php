            ...
            <div class="card mb-6">
                ...
                <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-8">
                    <div class="flex-shrink-0 mt-1 mx-sm-0 mx-auto">
                        <img src="{{ $employee->photo ? asset($employee->photo) : asset('dash/assets/img/avatars/7.png') }}"
                    ...
                    <div class="flex-grow-1 mt-3 mt-lg-5">
                        <div
                            ...
                            <div class="user-profile-info">
                                <h4 class="mb-2 mt-lg-7">{{ $employee->employee_name }}</h4>
                                <ul
            ...
            {{--    <div class="card-body invoice-preview-header rounded">
                    <div class="d-flex flex-wrap flex-column flex-sm-row justify-content-between text-heading">
                        <div class="mb-md-0 mb-6">
                            ...
                            <p class="mb-3">Department: {{ $employee->department?->name }}</p>
                        </div>
                        <div class="col-md-5 col-8 pe-0 ps-0 ps-md-2">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <object class="magnific" data="{{ asset($employee->fayda) }}" type="application/pdf"
                                        width="100%" height="100%">
                                    </object>
                                    <a href="{{ asset($employee->fayda) }}" class="btn btn-primary btn-sm" download><i
                                            class="fa fa-download">Dawnload
                                        </i></a>
                                    <a class="btn btn-success btn-sm" target="_blank"
                                        href="{{ asset($employee->fayda) }}"><i class="fa fa-search-plus"> </i>View Full
                                        Screen</a>
                                </div>
                            </div>
                            </div>
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $employee->date_of_birth ? \Carbon\Carbon::parse($employee->date_of_birth)->format('d/m/Y') : 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="pe-4 fw-medium">Gender:</td>
                                        <td>{{ $employee->gender == 'ወ' ? 'ወንድ' : ($employee->gender == 'ሴ' ? 'ሴት' : 'N/A') }}
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $employee->graduation_date ? \Carbon\Carbon::parse($employee->graduation_date)->format('d/m/Y') : 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $employee->salary ? number_format($employee->salary, 2) : 'N/A' }}
                                            ETB</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-4 fw-medium">Allowance:</td>
                                        <td>{{ $employee->allowance ? number_format($employee->allowance, 2) : 'N/A' }}
                                            ETB</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-4 fw-medium">Housing Allowance:</td>
                                        <td>{{ $employee->housing_allowance ? number_format($employee->housing_allowance, 2) : 'N/A' }}
                                            ETB</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $employee->assignment_date ? \Carbon\Carbon::parse($employee->assignment_date)->format('d/m/Y') : 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="{{ route('experiences.create', ['employee_id' => $employee->id]) }}"
                                        ...
                                        <tbody>
                                            @foreach ($employee->experiences->sortBy('display_order') as $index => $exp)
                                                <tr>
                                                    ...
                                                    <td>{{ $exp->from_date ? \Carbon\Carbon::parse($exp->from_date)->format('d/m/Y') : 'N/A' }}
                                                    </td>
                                                    <td>
                                                        @if ($exp->to_date)
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('experiences.show', $exp->id) }}">
                                                                        <i class="bx bx-show"></i> View
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('experiences.edit', $exp->id) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item text-danger" href="#"
                                                                        onclick="event.preventDefault(); if(confirm('Are you sure?')) document.getElementById('delete-exp-{{ $exp->id }}').submit();">
                                                                        <i class="bx bx-trash"></i> Delete
                                                                    </a>
                                                                    <form id="delete-exp-{{ $exp->id }}"
                                                                        action="{{ route('experiences.destroy', $exp->id) }}"
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $employee->created_at ? \Carbon\Carbon::parse($employee->created_at)->format('d/m/Y H:i') : 'N/A' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="pe-4 fw-medium">Last Updated:</td>
                                                <td>{{ $employee->updated_at ? \Carbon\Carbon::parse($employee->updated_at)->format('d/m/Y H:i') : 'N/A' }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
