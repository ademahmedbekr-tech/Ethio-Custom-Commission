                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="file_number" value="{{ old('file_number') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('gender') is-invalid @enderror" id="gender"
                                            ...
                                            <option value="ወ" {{ old('gender') == 'ወ' ? 'selected' : '' }}>ወንድ / Male
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('marital_status') is-invalid @enderror"
                                            ...
                                            <option value="Single"
                                                {{ old('marital_status') == 'Single' ? 'selected' : '' }}>ነጠላ / Single
                                            </option>
                                            <option value="Married"
                                                {{ old('marital_status') == 'Married' ? 'selected' : '' }}>ያገቡ / Married
                                            </option>
                                            <option value="Divorced"
                                                {{ old('marital_status') == 'Divorced' ? 'selected' : '' }}>የተፋቱ / Divorced
                                            </option>
                                            <option value="Widowed"
                                                {{ old('marital_status') == 'Widowed' ? 'selected' : '' }}>ባል/ሚስት የሞቱ /
                                                Widowed</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('ethnicity') is-invalid @enderror" id="ethnicity"
                                            ...
                                            <option value="Oromo" {{ old('ethnicity') == 'Oromo' ? 'selected' : '' }}>ኦሮሞ
                                                / Oromo</option>
                                            <option value="Amhara" {{ old('ethnicity') == 'Amhara' ? 'selected' : '' }}>አማራ
                                                / Amhara</option>
                                            <option value="Tigray" {{ old('ethnicity') == 'Tigray' ? 'selected' : '' }}>
                                                ትግራይ / Tigray</option>
                                            <option value="Somali" {{ old('ethnicity') == 'Somali' ? 'selected' : '' }}>ሶማሌ
                                                / Somali</option>
                                            <option value="Gurage" {{ old('ethnicity') == 'Gurage' ? 'selected' : '' }}>ጉራጌ
                                                / Gurage</option>
                                            <option value="Other" {{ old('ethnicity') == 'Other' ? 'selected' : '' }}>ሌላ /
                                                Other</option>
                                        </select>
                                        @error('ethnicity')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('religion') is-invalid @enderror" id="religion"
                                            ...
                                            <option value="ኦርቶዶክስ" {{ old('religion') == 'ኦርቶዶክስ' ? 'selected' : '' }}>
                                                Orthodox</option>
                                            <option value="ፕሮቴስታንት" {{ old('religion') == 'ፕሮቴስታንት' ? 'selected' : '' }}>
                                                Protestant</option>
                                            <option value="ሙስሊም" {{ old('religion') == 'ሙስሊም' ? 'selected' : '' }}>Muslim
                                            </option>
                                            <option value="Waaqeeffannaa"
                                                {{ old('religion') == 'Waaqeeffannaa' ? 'selected' : '' }}>Waaqeeffannaa
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('region') is-invalid @enderror" id="region"
                                            ...
                                            <option value="Addis Ababa"
                                                {{ old('region') == 'Addis Ababa' ? 'selected' : '' }}>አዲስ አበባ / Addis
                                                Ababa</option>
                                            <option value="Afar" {{ old('region') == 'Afar' ? 'selected' : '' }}>አፋር /
                                                Afar</option>
                                            <option value="Amhara" {{ old('region') == 'Amhara' ? 'selected' : '' }}>አማራ /
                                                Amhara</option>
                                            <option value="Benishangul-Gumuz"
                                                {{ old('region') == 'Benishangul-Gumuz' ? 'selected' : '' }}>ቤንሻንጉል ጉሙዝ /
                                                Benishangul-Gumuz</option>
                                            <option value="Dire Dawa"
                                                {{ old('region') == 'Dire Dawa' ? 'selected' : '' }}>ድሬዳዋ / Dire Dawa
                                            </option>
                                            <option value="Gambela" {{ old('region') == 'Gambela' ? 'selected' : '' }}>
                                                ጋምቤላ / Gambela</option>
                                            <option value="Harari" {{ old('region') == 'Harari' ? 'selected' : '' }}>ሐረሪ /
                                                Harari</option>
                                            <option value="Oromia" {{ old('region') == 'Oromia' ? 'selected' : '' }}>ኦሮሚያ
                                                / Oromia</option>
                                            <option value="Sidama" {{ old('region') == 'Sidama' ? 'selected' : '' }}>ሲዳማ /
                                                Sidama</option>
                                            <option value="Somali" {{ old('region') == 'Somali' ? 'selected' : '' }}>ሶማሌ /
                                                Somali</option>
                                            <option value="SNNPR" {{ old('region') == 'SNNPR' ? 'selected' : '' }}>ደቡብ /
                                                SNNPR</option>
                                            <option value="Tigray" {{ old('region') == 'Tigray' ? 'selected' : '' }}>ትግራይ
                                                / Tigray</option>
                                        </select>
                                        @error('region')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="zone" name="zone"
                                            value="{{ old('zone') }}" placeholder="ዞን / Zone">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="district" name="district"
                                            value="{{ old('district') }}" placeholder="ወረዳ / District">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="house_number" name="house_number"
                                            value="{{ old('house_number') }}" placeholder="ቤት ቁጥር">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="fan_number" name="fan_number" value="{{ old('fan_number') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="job_title" name="job_title"
                                            value="{{ old('job_title') }}" placeholder="ለምሳሌ: ኢንስፔክተር">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="job_level" name="job_level"
                                            value="{{ old('job_level') }}" min="1" max="100"
                                            placeholder="1-20">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="assignment_date"
                                            name="assignment_date" value="{{ old('assignment_date') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pension_id" name="pension_id"
                                            value="{{ old('pension_id') }}" placeholder="ፔንሽን ቁጥር">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="allowance"
                                            name="allowance" value="{{ old('allowance') }}" placeholder="0.00">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="housing_allowance"
                                            name="housing_allowance" value="{{ old('housing_allowance') }}"
                                            placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="education_level" name="education_level">
                                            ...
                                            <option value="High School"
                                                {{ old('education_level') == 'High School' ? 'selected' : '' }}>ሁለተኛ ደረጃ /
                                                High School</option>
                                            <option value="Certificate"
                                                {{ old('education_level') == 'Certificate' ? 'selected' : '' }}>ሰርተፍኬት /
                                                Certificate</option>
                                            <option value="Diploma"
                                                {{ old('education_level') == 'Diploma' ? 'selected' : '' }}>ዲፕሎማ / Diploma
                                            </option>
                                            <option value="Bachelor"
                                                {{ old('education_level') == 'Bachelor' ? 'selected' : '' }}>ባችለር /
                                                Bachelor</option>
                                            <option value="Master"
                                                {{ old('education_level') == 'Master' ? 'selected' : '' }}>ማስተርስ / Master
                                            </option>
                                            <option value="PhD"
                                                {{ old('education_level') == 'PhD' ? 'selected' : '' }}>ዶክትሬት / PhD
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="education_type"
                                            name="education_type" value="{{ old('education_type') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="institution" name="institution"
                                            value="{{ old('institution') }}" placeholder="የትምህርት ተቋም">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="cgpa"
                                            name="cgpa" value="{{ old('cgpa') }}" placeholder="0.00"
                                            max="4.00">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="higher_ed_verified"
                                                ...
                                                {{ old('higher_ed_verified') ? 'checked' : '' }}>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="previous_job_title"
                                                    name="previous_job_title" value="{{ old('previous_job_title') }}">
                                            </div>
                                            <div class="mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="disability_type" name="disability_type">
                                            ...
                                            <option value="None"
                                                {{ old('disability_type') == 'None' ? 'selected' : '' }}>የለም / None
                                            </option>
                                            <option value="Physical"
                                                {{ old('disability_type') == 'Physical' ? 'selected' : '' }}>አካላዊ /
                                                Physical</option>
                                            <option value="Visual"
                                                {{ old('disability_type') == 'Visual' ? 'selected' : '' }}>የማየት / Visual
                                            </option>
                                            <option value="Hearing"
                                                {{ old('disability_type') == 'Hearing' ? 'selected' : '' }}>የመስማት / Hearing
                                            </option>
                                        </select>
                                    </div>
                                </div>
