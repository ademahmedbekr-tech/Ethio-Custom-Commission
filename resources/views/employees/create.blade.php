    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="bs-stepper wizard-numbered mt-2">
            ...
            <div class="bs-stepper-content">
                <form id="wizard-numbered-form" action="{{ route('employees.store') }}" method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('gender') is-invalid @enderror" id="gender"
                                    ...
                                    <option value="ሌላ" {{ old('gender') == 'ሌላ' ? 'selected' : '' }}>ሌላ / Other
                                    </option>
                                </select>
                                @error('gender')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('marital_status') is-invalid @enderror"
                                    ...
                                    <option value="Single" {{ old('marital_status') == 'Single' ? 'selected' : '' }}>ነጠላ /
                                        Single</option>
                                    <option value="Married" {{ old('marital_status') == 'Married' ? 'selected' : '' }}>ያገቡ
                                        / Married</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('ethnicity') is-invalid @enderror" id="ethnicity"
                                    ...
                                    <option value="Oromo" {{ old('ethnicity') == 'Oromo' ? 'selected' : '' }}>ኦሮሞ / Oromo
                                    </option>
                                    <option value="Amhara" {{ old('ethnicity') == 'Amhara' ? 'selected' : '' }}>አማራ /
                                        Amhara</option>
                                    <option value="Tigray" {{ old('ethnicity') == 'Tigray' ? 'selected' : '' }}>ትግራይ /
                                        Tigray</option>
                                    <option value="Somali" {{ old('ethnicity') == 'Somali' ? 'selected' : '' }}>ሶማሌ /
                                        Somali</option>
                                    <option value="Gurage" {{ old('ethnicity') == 'Gurage' ? 'selected' : '' }}>ጉራጌ /
                                        Gurage</option>
                                    <option value="Other" {{ old('ethnicity') == 'Other' ? 'selected' : '' }}>ሌላ / Other
                                    </option>
                                </select>
                                @error('ethnicity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('religion') is-invalid @enderror" id="religion"
                                    ...
                                    <option value="ኦርቶዶክስ" {{ old('religion') == 'ኦርቶዶክስ' ? 'selected' : '' }}>Orthodox
                                    </option>
                                    ...
                                    <option value="Waaqeeffannaa"
                                        {{ old('religion') == 'Waaqeeffannaa' ? 'selected' : '' }}>Waaqeeffannaa</option>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('region') is-invalid @enderror" id="region"
                                    ...
                                    <option value="Addis Ababa" {{ old('region') == 'Addis Ababa' ? 'selected' : '' }}>አዲስ
                                        አበባ / Addis Ababa</option>
                                    <option value="Afar" {{ old('region') == 'Afar' ? 'selected' : '' }}>አፋር / Afar
                                    </option>
                                    <option value="Amhara" {{ old('region') == 'Amhara' ? 'selected' : '' }}>አማራ / Amhara
                                    </option>
                                    <option value="Benishangul-Gumuz"
                                        {{ old('region') == 'Benishangul-Gumuz' ? 'selected' : '' }}>ቤንሻንጉል ጉሙዝ /
                                        Benishangul-Gumuz</option>
                                    <option value="Dire Dawa" {{ old('region') == 'Dire Dawa' ? 'selected' : '' }}>ድሬዳዋ /
                                        Dire Dawa</option>
                                    <option value="Gambela" {{ old('region') == 'Gambela' ? 'selected' : '' }}>ጋምቤላ /
                                        Gambela</option>
                                    <option value="Harari" {{ old('region') == 'Harari' ? 'selected' : '' }}>ሐረሪ / Harari
                                    </option>
                                    <option value="Oromia" {{ old('region') == 'Oromia' ? 'selected' : '' }}>ኦሮሚያ / Oromia
                                    </option>
                                    <option value="Sidama" {{ old('region') == 'Sidama' ? 'selected' : '' }}>ሲዳማ / Sidama
                                    </option>
                                    <option value="Somali" {{ old('region') == 'Somali' ? 'selected' : '' }}>ሶማሌ / Somali
                                    </option>
                                    <option value="SNNPR" {{ old('region') == 'SNNPR' ? 'selected' : '' }}>ደቡብ / SNNPR
                                    </option>
                                    <option value="Tigray" {{ old('region') == 'Tigray' ? 'selected' : '' }}>ትግራይ / Tigray
                                    </option>
                                </select>
                                @error('region')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('fan_number') is-invalid @enderror"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control" id="housing_allowance"
                                    name="housing_allowance" value="{{ old('housing_allowance') }}" placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-12 d-flex justify-content-between mt-4">
                            <button type="button" class="btn btn-secondary btn-prev">
                    ...
                    <div id="education-docs" class="content">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="education_level" name="education_level">
                                    ...
                                    <option value="High School"
                                        {{ old('education_level') == 'High School' ? 'selected' : '' }}>ሁለተኛ ደረጃ / High
                                        School</option>
                                    ...
                                    <option value="Master" {{ old('education_level') == 'Master' ? 'selected' : '' }}>
                                        ማስተርስ / Master</option>
                                    <option value="PhD" {{ old('education_level') == 'PhD' ? 'selected' : '' }}>ዶክትሬት /
                                        PhD</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="education_type" name="education_type"
                                    value="{{ old('education_type') }}" placeholder="ለምሳሌ: የሙያ ትምህርት">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control" id="cgpa" name="cgpa"
                                    value="{{ old('cgpa') }}" placeholder="0.00" max="4.00">
                            </div>
                            <div class="col-md-4">
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="mb-2">
                                            <input type="text" class="form-control form-control-sm"
                                                ...
                                                value="{{ old('current_institution') }}" placeholder="ተቋም / Institution">
                                        </div>
                                        <div class="row g-2">
                                            <div class="col-6"><input type="date"
                                                    class="form-control form-control-sm" id="experience_from"
                                                    name="experience_from" value="{{ old('experience_from') }}"></div>
                                            <div class="col-6"><input type="date"
                                                    class="form-control form-control-sm" id="experience_to"
                                                    name="experience_to" value="{{ old('experience_to') }}"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-6"><input type="date"
                                                    ...
                                                    name="previous_from" value="{{ old('previous_from') }}"></div>
                                            <div class="col-6"><input type="date"
                                                    class="form-control form-control-sm" id="previous_to"
                                                    name="previous_to" value="{{ old('previous_to') }}"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="disability_type" name="disability_type">
                                    ...
                                    <option value="None" {{ old('disability_type') == 'None' ? 'selected' : '' }}>የለም /
                                        None</option>
                                    <option value="Physical" {{ old('disability_type') == 'Physical' ? 'selected' : '' }}>
                                        አካላዊ / Physical</option>
                                    <option value="Visual" {{ old('disability_type') == 'Visual' ? 'selected' : '' }}>የማየት
                                        / Visual</option>
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" id="diagnosis" name="diagnosis"
                                    value="{{ old('diagnosis') }}" placeholder="የምርመራ ዝርዝር መግለጫ">
                            </div>
                        ...
                        <div class="col-12 d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="{{ route('employees.index') }}" class="btn btn-label-secondary me-2">ሰርዝ /
                                    Cancel</a>
