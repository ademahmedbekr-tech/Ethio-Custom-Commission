                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <form action="abroadMember-pay" method="POST" enctype="multipart/form-data" style="display: flex; align-items: center;">
                                        @csrf
                                        <label for="country" style="margin-right: 10px;">Country</label>
                                        <select name="country" id="country" class="form-control dynamic" data-dependent="woreda" style="display: inline-block;width:35%;margin-right:10px;">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-sortable pb-1 mt-2">
                                ...
                                <tbody>
                                    ...
                                    @forelse($pays as $pay)
                                    <tr>
                                        <td class="border py-2">{{ $pay->country }}</td>
