...
@section('model','Region Member Payment')
@section('title','Region Member Payment')
{{-- @section('back',route('{{ $model }}.index')) --}}
@section('type','Create')
@section('form')


<form method="POST" action="{{ route('regionMemberPay.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="region" name="region" value="{{ $member->region }}">
