...
@section('route',route('sh_kaabaa.create'))
@section('import',route('sh_kaabaa.import'))
@section('filterAction', route('sh_kaabaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('sh_kaabaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        {{-- Delete --}}
                        @can('sh_kaabaa-delete')
                        <li>
                            <form action="{{ route('sh_kaabaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('sh_kaabaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
