...
@section('route',route('w_bahaa.create'))
@section('import',route('w_bahaa.import'))
@section('filterAction', route('w_bahaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('w_bahaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('w_bahaa-delete')
                        <li>
                            <form action="{{ route('w_bahaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('w_bahaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
