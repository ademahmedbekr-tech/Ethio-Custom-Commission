...
@section('route',route('sh_k_lixaa.create'))
@section('import',route('sh_k_lixaa.import'))
@section('filterAction', route('sh_k_lixaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('sh_k_lixaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        {{-- Delete --}}
                        @can('sh_k_lixaa-delete')
                        <li>
                            <form action="{{ route('sh_k_lixaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('sh_k_lixaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
