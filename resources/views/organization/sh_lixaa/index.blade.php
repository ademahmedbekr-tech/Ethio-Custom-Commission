...
@section('route',route('sh_lixaa.create'))
@section('import',route('sh_lixaa.import'))
@section('filterAction', route('sh_lixaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('sh_lixaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('sh_lixaa-delete')
                        <li>
                            <form action="{{ route('sh_lixaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('sh_lixaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
