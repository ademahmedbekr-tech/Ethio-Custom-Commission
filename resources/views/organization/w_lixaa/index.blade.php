...
@section('count',$count)
@section('title','Wallaggaa Lixaa')
@section('insert','Wallagga Lixaa')
@section('icons','layout')
@section('route',route('w_lixaa.create'))
@section('import',route('w_lixaa.import'))
@section('filterAction', route('w_lixaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('w_lixaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('w_lixaa-delete')
                        <li>
                            <form action="{{ route('w_lixaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('w_lixaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
