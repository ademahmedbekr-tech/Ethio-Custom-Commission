...
@section('route',route('qeellam.create'))
@section('import',route('qeellam.import'))
@section('filterAction', route('qeellam.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('qeellam.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('qeellam-delete')
                        <li>
                            <form action="{{ route('qeellam.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('qeellam.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
