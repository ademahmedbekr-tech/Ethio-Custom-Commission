                ...
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 mb-3">
                                    <form action="regionMemberFee-report" method="POST" enctype="multipart/form-data" style="display: flex; align-items: center;">
                                        @csrf
                                        <label for="region" style="margin-right: 10px;">Region</label>
                                        <select name="region" id="region" class="form-control dynamic" data-dependent="woreda" style="display: inline-block;width:35%;margin-right:10px;" required>
                                ...
                                @if($export == true)
                                {{-- <form action="regionMemberFee-Export" method="POST" enctype="multipart/form-data" style="display: flex; align-items: center;">
                    <input type="hidden" name="region" value="{{ $region }}">
                                ...
                                <div class="col-6 mb-3 align-content-end" style="text-align: right;">
                                    ...
                                    <a href="regionMemberFee-export/{{ $region }}/{{ $month }}/{{ $year }}" class="btn btn-sm btn-success">Download</a>
                                </div>
                                {{-- </form> --}}
                                @endif
                            </div>
