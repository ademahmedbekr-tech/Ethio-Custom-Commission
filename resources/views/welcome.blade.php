...
<html lang="en" class="layout-navbar-fixed layout-wide" dir="ltr" data-skin="default"
    data-assets-path="../../dash/assets/" data-template="front-pages" data-bs-theme="light">
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dash/assets/vendor/fonts/iconify-icons.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('dash/assets/vendor/css/pages/front-page.css') }}" />

    <!-- Vendors CSS -->

    <!-- endbuild -->

    <link rel="stylesheet" href="{{ asset('dash/assets/vendor/libs/nouislider/nouislider.css') }}" />
    <link rel="stylesheet" href="{{ asset('dash/assets/vendor/libs/swiper/swiper.css') }}" />

    <!-- Page CSS -->

    <link rel="stylesheet" href="{{ asset('dash/assets/vendor/css/pages/front-page-landing.css') }}" />
    ...
    <script src="{{ asset('dash/assets/js/front-config.js') }}"></script>
</head>

<body>
    <script src="{{ asset('dash/assets/vendor/js/dropdown-hover.js') }}"></script>
    <script src="{{ asset('dash/assets/vendor/js/mega-dropdown.js') }}"></script>
    <!-- Navbar: Start -->
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-4 d-none d-lg-block">
                                        <div class="bg-body nav-img-col p-2">
                                            <img src="{{ asset('dash/assets/img/front-pages/misc/nav-item-col-img.png') }}"
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        ...
        <section id="hero-animation">
            <div id="landingHero" class="section-py landing-hero position-relative">
                <img src="{{ asset('dash/assets/img/front-pages/backgrounds/hero-bg.png') }}" alt="hero background"
                    ...
                    <div class="hero-text-box text-center position-relative">
                        ...
                        <div class="landing-hero-btn d-inline-block position-relative">
                            <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">Join community
                                <img src="{{ asset('dash/assets/img/front-pages/icons/Join-community-arrow.png') }}"
                    ...
                    <div id="heroDashboardAnimation" class="hero-animation-img">
                        <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
                            <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                                <img src="{{ asset('dash/assets/img/front-pages/landing-page/hero-dashboard-light.png') }}"
                                    alt="hero dashboard" class="animation-img"

                                     />
                                <img src="{{ asset('dash/assets/img/front-pages/landing-page/hero-elements-light.png') }}"
                                    alt="hero elements"
            ...
            <div class="container">
                ...
                <h4 class="text-center mb-1">
                    <span class="position-relative fw-extrabold z-1">Everything you need
                        <img src="{{ asset('dash/assets/img/front-pages/icons/section-title-icon.png') }}"
                            alt="laptop charging"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <div class="mb-4">
                                                    <img src="{{ asset('dash/assets/img/front-pages/branding/logo-1.png') }}"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="{{ asset('dash/assets/img/front-pages/branding/logo-2.png') }}"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
            ...
            <div class="container">
                <div class="swiper-logo-carousel pt-8">
                    <div class="swiper" id="swiper-clients-logos">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('dash/assets/img/front-pages/branding/logo_1-light.png') }}" alt="client logo"
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('dash/assets/img/front-pages/branding/logo_2-light.png') }}" alt="client logo"
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('dash/assets/img/front-pages/branding/logo_3-light.png')}}" alt="client logo"
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('dash/assets/img/front-pages/branding/logo_4-light.png') }}" alt="client logo"
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('dash/assets/img/front-pages/branding/logo_5-light.png') }}" alt="client logo"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('dash/assets/img/front-pages/landing-page/team-member-1.png') }}"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('dash/assets/img/front-pages/landing-page/team-member-2.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50" alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('dash/assets/img/front-pages/landing-page/team-member-3.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50" alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('dash/assets/img/front-pages/landing-page/team-member-4.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50" alt="human image" />
                            </div>
    ...
    <footer class="landing-footer bg-body footer-text">
        <div class="footer-top position-relative overflow-hidden z-1">
            <img src="{{ asset('dash/assets/img/front-pages/backgrounds/footer-bg.png') }}" alt="footer bg"
    ...
    <script src="{{ asset('dash/assets/vendor/libs/@algolia/autocomplete-js.js') }}"></script>

    <script src="{{ asset('dash/assets/vendor/libs/pickr/pickr.js') }}"></script>

    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{ asset('dash/assets/vendor/libs/nouislider/nouislider.js') }}"></script>
    <script src="{{ asset('dash/assets/vendor/libs/swiper/swiper.js') }}"></script>

    <!-- Main JS -->

    <script src="{{ asset('dash/assets/js/front-main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('dash/assets/js/front-page-landing.js') }}"></script>
</body>
