             ...
             <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
                 <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                     ...
                     <span class="position-relative">
                         ...
                         @if ($unReadMessages > 0)
                             <span
                                 class="badge rounded-pill bg-danger text-bg-danger badge-notifications ms-auto">{{ $unReadMessages }}</span>
                         @endif
                 ...
                 <ul class="dropdown-menu dropdown-menu-end p-0">
                                 ...
                                 <div class="d-flex">
                                     ...
                                     @if ($unReadMessages > 0)
                                         <div class="flex-grow-1">
                                             ...
                                             <small class="mb-1 d-block text-body">{{ $notification->description }}
                                             </small>
                                             <small class="text-body-secondary"> at {{ $notification->created_at }}
                                             </small>
                                         </div>
                                     @endif
                     ...
                     <li class="border-top">
                         <div class="d-grid p-4">
                             <a class="btn btn-primary btn-sm d-flex" href="{{ route('notification.index') }}">
             ...
             <li class="nav-item navbar-dropdown dropdown-user dropdown">
                 <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                     ...
                     <div class="avatar avatar-online">
                         <img src="{{ asset('dash/assets/img/avatars/1.png') }}" alt class="rounded-circle" />
                     </div>
                 </a>
                 <ul class="dropdown-menu dropdown-menu-end">
                     <li>
