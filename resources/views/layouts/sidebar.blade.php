    ...
    <div class="app-brand demo">
        <a href="#" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="{{ asset('front/images/Picture1.jpg') }}" height="40em" width="40em"
        ...
        <li class="menu-item {{ Request::is('managers') ? 'active' : '' }} open">
         ...
         <li class="menu-item {{ Request::is('notification') ? 'active' : '' }}">
            <a href="{{ route('notification.index') }}" class="menu-link">
              ...
              <div class="badge text-bg-danger rounded-pill ms-auto"> {{ $unReadMessages }} </div>

            </a>
        </li>
         <li class="menu-item {{ Request::is('maintainance-mode') ? 'active' : '' }}">
            <a href="{{ route('maintainance-mode') }}" class="menu-link">
