   ...
   <script async defer src="https://buttons.github.io/buttons.js"></script>
    ...
    {{-- <script src="{{ asset('dash/assets/vendor/libs/dropzone/dropzone.js') }}"></script> --}}


    {{-- <script src="{{ asset('dash/assets/js/forms-file-upload.js') }}"></script> --}}
...
<script src="{{ asset('dash/assets/vendor/libs/quill/katex.js') }}"></script>
    <script src="{{ asset('dash/assets/vendor/libs/highlight/highlight.js') }}"></script>
    <script src="{{ asset('dash/assets/vendor/libs/quill/quill.js') }}"></script>
...
<script src="{{ asset('dash/assets/js/app-access-permission.js') }}" >  </script>
    ...
    {{-- <script src="{{ asset('dash/assets/js/app-logistics-dashboard.js') }}"></script> --}}
 {{-- <script src="{{ asset('dash/assets/vendor/libs/moment/moment.js') }}"></script>
  ...
  <script src="{{ asset('dash/assets/vendor/libs/@form-validation/auto-focus.js') }}"></script>
  <script src="{{ asset('dash/assets/vendor/libs/cleave-zen/cleave-zen.js') }}"></script> --}}
   {{-- <script src="{{ asset('dash/assets/vendor/libs/quill/katex.js') }}"></script>
