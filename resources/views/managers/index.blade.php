                            ...
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{ $totalmanagers }}</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{ $managersWithHeads }}</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{ $managersWithoutHeads }}</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{ $recentmanagers }}</h4>
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    ...
                    <div class="d-flex justify-content-between align-items-center row pt-4 gap-md-0 g-6">
                        <div class="col-mb-4 align-content-end text-end">
                            <a href="{{ route('managers.create') }}" class="btn btn-sm btn-primary">
                ...
                <div class="card-datatable">
                    <table class="datatables-users table border-top table-striped">
                        ...
                        <tbody>
                            @foreach ($managers as $dept)
                                <tr>
                                    <td>{{ $dept->id }}</td>
                                    <td>{{ $dept->name }}</td>
                                    <td>
                                        {{ $dept->department?->name }} </td>
                                    <td>{{ $dept->description }}</td>
                                    {{-- <td>{{ $dept->head_id }}</td> --}}
                                    <td>
                                        <div class="d-flex gap-2">
                                            <!-- View Button -->
                                            <a href="{{ route('managers.show', $dept->id) }}" class="btn btn-sm btn-info"
                                                title="View Department">
                                                <i class="bx bx-show"></i>
                                            </a>

                                            <!-- Edit Button -->
                                            <a href="{{ route('managers.edit', $dept->id) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('managers.destroy', $dept->id) }}"
