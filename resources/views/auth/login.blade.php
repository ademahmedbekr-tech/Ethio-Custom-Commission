...
<head>
    ...
    <!-- Favicon -->
    {{-- <link rel="icon"  type="image" style="border-radius: 50%" href="{{ asset('assets/img/favicon/image.jpg') }}" /> --}}
    <link rel="icon" style="border-radius: 50%" type="image" href="{{ asset('Photo/Picture1.jpg')}}" />
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        {{-- <div class="card-header card-header-success text-center"> --}}
                            ...
                            <h5 class="card-title"><strong>{{ __('Ethiopian Customs Commission(ECC) ') }}</strong></h5>
                            <img src="{{ asset('Photo/Picture1.jpg') }}" alt="Logo" class="w-20 h-20"
                        ...
                        <form class="form mb-6" action ="{{ route('login') }}" method="POST">
                            @csrf
