                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-unstyled g-2 my-6">
                        <li class="mb-2 d-flex align-items-center">
                          <i class="icon-base bx bxs-circle icon-6px text-secondary me-2"></i><span>10 Users</span>
                        </li>
                        <li class="mb-2 d-flex align-items-center">
                          <i class="icon-base bx bxs-circle icon-6px text-secondary me-2"></i
                          ><span>Up to 10 GB storage</span>
                        </li>
                        <li class="mb-2 d-flex align-items-center">
                          <i class="icon-base bx bxs-circle icon-6px text-secondary me-2"></i><span>Basic Support</span>
                        </li>
                      </ul>
                    ...
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 flex-wrap row-gap-2">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="app-user-view-connections.html"
                          ><i class="icon-base bx bx-link icon-sm me-1_5"></i>Connections</a
                        >
                      </li>
                    </ul>
                  </div>
