                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('experience_type') is-invalid @enderror"
                                                ...
                                                <option value="previous" {{ old('experience_type', $experience->experience_type) == 'previous' ? 'selected' : '' }}>Previous Experience</option>
                                                <option value="current" {{ old('experience_type',$experience->experience_type) == 'current' ? 'selected' : '' }}>Current Experience</option>
                                            </select>
